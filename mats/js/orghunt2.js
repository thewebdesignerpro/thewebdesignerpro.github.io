...
function onWindowScroll( event ) {
	...
	ui.frontobj1.style.bottom = '' + scrollPos * -.4 + 'px' +'';
	
	if (scrollPos < (win.height*.65)) ui.logo.style.top = '' + scrollPos * 1.5 + 'px' +'';
	
	if (scrollPos > (win.height*.7)) {
		ui.background1.style.opacity = ui.frontobj1.style.opacity = 1 - (scrollPos * .001); 
	} else {
	...
	ui.ctr1.style.bottom = '' + scrollPos * .1 + 'px' +'';
