...
//	if (win.height > win.width) logoCtr = 1.1; 
	...
	if (scrollPos > (win.height*opacH)) {
		//ui.background1.style.opacity = 1 - (scrollPos * .0008); 
		//ui.frontobj1.style.opacity = 1 - (scrollPos * .0007); 
		ui.background1.style.opacity = 1 - (scrollPos * .00037); 
		ui.frontobj1.style.opacity = 1 - (scrollPos * .00037); 
	} else {
