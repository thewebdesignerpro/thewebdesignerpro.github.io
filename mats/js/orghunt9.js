...
function onDocuBodyScroll( scrollPos ) {
	...
	//	ui.background1.style.top = '' + scrollPos * .7 + 'px' +'';
		...
		ui.background1.style.transform = 'translateY(' + scrollPos * .7 + 'px)';
		ui.frontobj1.style.transform = 'translateY(' + scrollPos * .64 + 'px)';
	}
...
function onMouseMove( event ) {
	...
	//const fob1l = bgRY*2.5 + win.fobjLeft; 
	
//	const fobjBRX = (fobjB - bgRX) * -1; 
	...
	if (!ticking) {
		...
		//ui.background1.style.transform = 'translateX(' + bgRY + 'px)'; 
		//ui.frontobj1.style.transform = 'translateX(' + fob1l + 'px)'; 
		//ui.frontobj1.style.transform = 'translate(' + fob1l + 'px, ' + bgRX + 'px)'; 
		//ui.frontobj1.style.transform = 'translateY(' + fob1l + 'px)'; 
