...
var clfMap = THREE.ImageUtils.loadTexture( "imj/shade/dirt3.jpg" );
...
function clF() {				
	...
	loader.load('obj/clif3.json', function (geometry, materials) {
		...
		var clif = new THREE.Mesh(geometry, material);	  
