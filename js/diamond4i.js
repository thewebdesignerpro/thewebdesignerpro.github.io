...
function bB() {				
	...
	loader.load('obj/diamond-round.json', function (geometry, materials) {
		...
		mater = new THREE.MeshPhongMaterial({envMap: cubeMap, overdraw: 0.5, side: THREE.FrontSide, wireframe: false, transparent: true, opacity: 0.3, shading: THREE.FlatShading, shininess: 60, metal: false, combine: THREE.MixOperation});
		...
		var materR = new THREE.MeshPhongMaterial({envMap: cubeMapR, overdraw: 0.5, transparent: true, opacity: 0.7, shading: THREE.FlatShading, refractionRatio: 0.9});
