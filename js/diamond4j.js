...
function bB() {				
	...
	loader.load('obj/diamond-round.json', function (geometry, materials) {
		...
		mater = new THREE.MeshPhongMaterial({envMap: cubeMap, overdraw: 0.5, side: THREE.DoubleSide, wireframe: false, transparent: true, opacity: 0.4, shading: THREE.FlatShading, shininess: 60, metal: false, combine: THREE.MixOperation});
		...
		var materR = new THREE.MeshPhongMaterial({envMap: cubeMapR, overdraw: 0.5, side: THREE.DoubleSide, transparent: true, opacity: 0.6, shading: THREE.FlatShading, refractionRatio: 0.6});
		...
		mater = new THREE.MeshPhongMaterial({envMap: rainbMap, transparent: true, opacity: 0.11, shading: THREE.FlatShading});
