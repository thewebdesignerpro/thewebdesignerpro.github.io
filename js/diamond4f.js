...
loada.load('imj/map/cube/skybox9.jpg', function(tex) {
...
function bB() {				
	...
	loader.load('obj/diamond-round.json', function (geometry, materials) {
		...
		mater = new THREE.MeshPhongMaterial({envMap: cubeMapR, overdraw: 0.5, transparent: true, opacity: 0.7, shading: THREE.FlatShading, refractionRatio: 0.96});
