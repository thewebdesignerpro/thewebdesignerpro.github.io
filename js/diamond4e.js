...
function bB() {				
	...
	loader.load('obj/diamond-round.json', function (geometry, materials) {
		...
		mater = new THREE.MeshPhongMaterial({envMap: cubeMap, overdraw: 0.5, side: THREE.FrontSide, wireframe: false, transparent: true, opacity: 0.5, shading: THREE.FlatShading, shininess: 60, metal: false});
		...
		mater = new THREE.MeshPhongMaterial({envMap: cubeMapR, overdraw: 0.5, transparent: true, opacity: 0.5, shading: THREE.FlatShading, refractionRatio: 0.98});
		...
		mater = new THREE.MeshPhongMaterial({envMap: rainbMap, transparent: true, opacity: 0.04, shading: THREE.FlatShading});
