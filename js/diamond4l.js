...
scene.add( pointL3 );
var pointL4 = new THREE.PointLight( 0xffffff, 1, 3 );
pointL4.position.set( -3, 0.1, 4 );
scene.add( pointL4 );
var pointL5 = pointL4.clone();
var pointL6 = pointL4.clone();
var pointL7 = pointL4.clone();
var pointL8 = pointL4.clone();
pointL5.position.set( 3, 0.1, -4 );
scene.add( pointL5 );
pointL6.position.set( -4, 0.1, 4 );
scene.add( pointL6 );
pointL7.position.set( -3, 0.1, -3 );
scene.add( pointL7 );
pointL8.position.set( 3, 0.1, 3 );
scene.add( pointL8 );

var sphereSize = 1;
var pointLightHelper = new THREE.PointLightHelper( pointL4, sphereSize );
...
//loada.load('imj/map/cube/skybox11.jpg', function(tex) {
//loada.load('imj/map/cube/skybox12.jpg', function(tex) {
//loada.load('imj/map/cube/skybox14.jpg', function(tex) {
//loada.load('imj/map/cube/skybox15.jpg', function(tex) {
//loada.load('imj/map/cube/skybox16.png', function(tex) {
//loada.load('imj/map/cube/skybox6lp.png', function(tex) {
//loada.load('imj/map/cube/skybox11lp.png', function(tex) {
//loada.load('imj/map/cube/skybox11lp2.png', function(tex) {
//loada.load('imj/map/cube/skybox11b2lp.png', function(tex) {
//loada.load('imj/map/cube/houseofepc3.jpg', function(tex) {
//loada.load('imj/map/cube/skyboxbw.jpg', function(tex) {
//loada.load('imj/map/cube/skybox17.jpg', function(tex) {
loada.load('imj/map/cube/skybox17lp2.jpg', function(tex) {
...
mater = new THREE.MeshPhongMaterial({envMap: cubeMap, overdraw: 0.5, side: THREE.DoubleSide, wireframe: false, transparent: true, opacity: 0.35, shading: THREE.FlatShading, shininess: 60, metal: false, reflectivity: .9, combine: THREE.MixOperation});
...
//var materR = new THREE.MeshPhongMaterial({envMap: cubeMapR, overdraw: 0.5, side: THREE.DoubleSide, transparent: true, opacity: 0.65, shading: THREE.FlatShading, refractionRatio: 0.15});
var materR = new THREE.MeshPhongMaterial({envMap: cubeMapR, overdraw: 0.5, side: THREE.DoubleSide, transparent: true, opacity: 0.63, shading: THREE.FlatShading, refractionRatio: 0.64});
		//cubeMap.mapping = THREE.CubeRefractionMapping;
		diamondR = new THREE.Mesh(geometry, materR);	  
		var scale = 1;
		...
		mater = new THREE.MeshPhongMaterial({envMap: rainbMap, transparent: true, opacity: 0.1, shading: THREE.FlatShading, refractionRatio: 0.33});
		...
		mater = new THREE.MeshPhongMaterial({map: tri1, transparent: true, opacity: 0.90, overdraw: 0.5, side: THREE.BackSide});
...
//renderer.DEPTH_TEST.enabled;
//renderer.depthFunc(LEQUAL);  
