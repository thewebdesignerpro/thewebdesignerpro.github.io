...
(function() {
  ...
  NoteRain = (function() {
    ...
    //NoteRain.prototype.lengthScale = 0.01;
        ...
        tasks.push((function(group) {
          return function(done) {
            ...
            for (_j = 0, _len1 = group.length; _j < _len1; _j++) {
              ...
              y = startTime * _this.lengthScale + (length / 2) - 2;
              //z = -0.2;
              //z = 8.04;
              z = 0.04;
              ...
              //geometry = new THREE.PlaneGeometry(blackKeyWidth, length);
              //geometry = new THREE.SphereGeometry(blackKeyWidth/2, 3, 2);
              //geometry = new THREE.CylinderGeometry(blackKeyWidth, blackKeyWidth, length, 3, 1, true);
              geometry = new THREE.CylinderGeometry(blackKeyWidth*.4, blackKeyWidth*.4, length, 3, 1, true);
...
/*			  material = new THREE.SpriteMaterial( {color: color, fog: true, transparent: true, opacity: 0.7} );			
			  mesh = new THREE.Sprite(material);	
			  mesh.scale.x = blackKeyWidth;
			  mesh.scale.y = length;*/
			  //mesh.scale.y = length/blackKeyWidth;
