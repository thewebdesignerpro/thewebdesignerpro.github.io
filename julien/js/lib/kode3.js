...
function exploreClick(e) {
	...
	var tweenE = new TWEEN.Tween( mesh.sunGlow.scale )
		...
		.onUpdate(function() {
			...
			mesh.planet[0].material.opacity = mesh.asteroids.material.opacity = mesh.asteroids2.material.opacity = mesh.asteroids3.material.opacity = mesh.satellite.material.opacity = this.x; 
		})
		.onComplete(function() {
			...
			mesh.satellite.material.transparent = false; 
			...
			mesh.asteroids.material.opacity = mesh.asteroids2.material.opacity = mesh.asteroids3.material.opacity = mesh.satellite.material.opacity = 1; 
		})
		.start();		
