...
function uiX() {
	...
	if (themodels[curNum][3]<k8v.innerHTML) {
		k8.value = k8v.innerHTML = k8.max = themodels[curNum][3];
	} else {
...
function initUI() {
	...
	k8.value = k8v.innerHTML = themodels[curNum][3];
	uiX();
}
...
function animate() {
	...
	//controls.center.set(0, spotL.position.y, 0);
	controls.center.set(0, springL/2, 0);
