...
//	renderer.sortObjects = false;	
	...
	x.spotLight[0] = new THREE.SpotLight( 0xffffff, 5000, 100, Math.PI/8, 1 );
...
function prepSphere() {
	...
	loader.load( url2 + fileName + frmt, function(tx) { 	
		...
		const material = new THREE.MeshLambertMaterial({ displacementMap: tx, displacementScale: 2 }); 
