...
var nodesOrbs = [], airplanes = [], targetOrbs = [], linksLines = [], firefly = [], theFireflies = [], fireflyTexture = [], 
	fireflyCount = [], tweenFireflies = [], tweenSet = [], ii = [], iii = [], initX1 = [], initY1 = [], initZ1 = [], tpwl = [], currNode = [], 
	thePathway = [], thePathwayLength = [], streamGroup = [], streamLength = [], globalTime = [0.0, 0.100];
...
// Quantities, values	
var currStream = 0, speedStep = 100;
...
function animateFireflies(ffly, callback) {
	...
	var x1 = y1 = z1 = x2 = y2 = z2 = r1 = g1 = b1 = r2 = g2 = b2 = nodeR = nodeG = nodeB = 0;
	...
	r1 = nodeR = theFireflies[currStream][ffly].material.color.r;
	g1 = nodeG = theFireflies[currStream][ffly].material.color.g;
	b1 = nodeB = theFireflies[currStream][ffly].material.color.b;
	...
	for (var i = 0; i < thePathwayLength[currStream][ffly] + 1; i++) {	
		...
		tweenSet[currStream][ffly][i] = new TWEEN.Tween(theFireflies[currStream][ffly].position)
			...
			.onComplete(function() {
				...
				if (iii[ffly] == thePathway2[currStream][ffly].length - 1) {
					iii[ffly] = 0;
	...
	streamGroup[currStream].add(pathLines);	
