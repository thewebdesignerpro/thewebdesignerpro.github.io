...
// Shorthands
var theNodes = data.features[0].children, theTargets = data.features[1].children, theLinks = data.features[2].children;

var airportMesh, airplaneMesh, dataTargetsLength, dataNodesLength, dataLinksLength, nodesOrbs = [], airplanes = [], airplaneOrbs = [], linksLines = [];

var airportObjLoaded = false;

var offset_x = 77.5, offset_z = 415;
