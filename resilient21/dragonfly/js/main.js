...
var airportMesh, airplaneMesh, dataTargetLength, airplanes = [];
...
function createOrbsNodes() {
	dataTargetLength = data.features[1].children.length;
	//console.log(dataLength);
	
	for (var i = 0; i < dataTargetLength; i++) {
